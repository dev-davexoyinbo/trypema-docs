...
::warning
For the Redis provider, keep configuration identical across instances: `window_size_seconds`, `rate_group_size_ms`, `hard_limit_factor`, and `suppression_factor_cache_ms`.
::
