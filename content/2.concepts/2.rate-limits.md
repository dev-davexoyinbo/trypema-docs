...
::note
Internally, counters are integers. For non-integer rates, the effective capacity is enforced using integer comparisons, so you should treat the limit as best-effort at the edges.
::
