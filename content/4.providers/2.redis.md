...
Each Lua script execution is atomic in Redis, but overall limiting is best-effort (concurrent clients may temporarily overshoot).

This is expected: atomic script execution does not make a multi-client system fully linearizable.
