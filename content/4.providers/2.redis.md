...
description: Distributed rate limiting via atomic Lua scripts against Redis 6.2+ — shared limits across processes and servers.
navigation:
  icon: i-lucide-database
---

The Redis provider executes all operations as atomic Lua scripts against a Redis 6.2+ server. Each `inc()` call results in one Redis round-trip. Use this when you need rate limits shared across multiple processes or servers.
