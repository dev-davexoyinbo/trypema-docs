...
The Redis provider executes all operations as atomic Lua scripts against a Redis 6.2+ server. Every `inc()` call results in one Redis round-trip. Use this when you need rate limits shared across multiple processes or servers.
