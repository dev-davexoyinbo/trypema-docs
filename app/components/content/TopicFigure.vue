...
const visuals = {
  ...
  sliding: {
    ...
    labels: ["Expired", "Live window", "Time →"],
  ...
  conditional: {
    ...
    labels: ["Compare", "Replace", "Preserve"],
  ...
  cleanup: {
    ...
    labels: ["Live state", "Stale state", "Cleanup"],
  ...
  benchmarks: {
    ...
    labels: ["Throughput", "Tail latency", "Contention"],
  ...
  migration: {
    ...
    labels: ["v1 facade", "Validated migration", "v2 providers"],
